...
namespace VertaIT.WPF.NetDemo.ViewModels
{
    public enum Theme
    {
        [ResourceUriPath(@"pack://application:,,,/VertaIT.WPF.NetTheme;component/Themes/LightTheme.xaml")]
        Light,
        [ResourceUriPath(@"pack://application:,,,/VertaIT.WPF.NetTheme;component/Themes/DarkTheme.xaml")]
        Dark
    }
